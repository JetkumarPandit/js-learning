...
console.log(`WAP to print numbers form 5 to 15 increment by 1 `);
...
console.log(`WAP to print numbers form 50 to 40 decrementing  by 1 `);
...
console.log(`WAP to print table of 10 in reverce order`);
